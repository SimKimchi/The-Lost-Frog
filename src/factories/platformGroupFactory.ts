...
export default abstract class PlatformGroupFactory {
  public static createJunglePlatformGroup(
    ...
    const platformArray: Platform[] = [
      ...
      { x: 7, y: 5, config: jungleH1Config },
      { x: 8, y: 5, config: jungleH1Config },
      { x: 9, y: 5, config: jungleH1Config },
      { x: 8, y: 8, config: jungleH1Config },
      { x: 8, y: 3, config: jungleH1Config },
      { x: 9, y: 3, config: jungleH1Config },
      { x: 10, y: 3, config: jungleH1Config },
      ...
      { x: 16, y: 8, config: jungleH1Config },
      ...
      { x: 25, y: 3, config: jungleH1Config },
      { x: 26, y: 3, config: jungleH1Config },
      { x: 4, y: 5, xOffSet: 16, config: jungleV1Config },
      { x: 4, y: 4, xOffSet: 16, config: jungleV1Config },
      { x: 4, y: 6, xOffSet: 16, config: jungleV1Config },
